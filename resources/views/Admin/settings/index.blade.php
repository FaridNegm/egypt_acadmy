...
@section('content')
    ...
    <div class="page-header page-header-default">
        ...
        <div class="breadcrumb-line">
            <ul class="breadcrumb">
                <li><a href="{{ url('/users/ar') }}"><i class="icon-home2 position-left"></i> {{ trans('app.home') }} </a></li>
